...
const Wishlist = () => {
  ...
  const { wishlistData, removewishItem, emptywishItem } = useContext(CartContext);
                                  ...
                                  <tr key={key}>
                                    <td className="product-thumbnail">
                                      <Link to={process.env.PUBLIC_URL + "/product/" + cartItem.productId}>
                                        <img
                                          className="img-fluid"
                                          src={`https://sanjaytestbucket.s3.ap-south-1.amazonaws.com/${cartItem.productImage[0]}`}
                                          alt=""
                                        />
                                      </Link>
                                    </td>
                                    ...
                                    <td className="product-name text-center">
                                      <Link to={process.env.PUBLIC_URL + "/product/" + cartItem.productId}> {cartItem.productName}</Link>
                                    </td>
                                    ...
                                    <td className="product-remove">
                                      <button onClick={() => removewishItem(cartItem)}>
                    ...
                    <div className="col-lg-12">
                      <div className="cart-shiping-update-wrapper">
                        ...
                        <div className="cart-clear">
                          <button onClick={() => emptywishItem()}>Clear Shopping Cart</button>
                        </div>
                      </div>
                    </div>
                  </div>
